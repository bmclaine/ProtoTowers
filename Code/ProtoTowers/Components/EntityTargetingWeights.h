...
#define MAX_WEIGHT_SPAWNER			15.0f
/// Turrets
#define MAX_WEIGHT_AUTO_TURRET		5.0f
#define MAX_WEIGHT_POISON_TURRET	5.0f
#define MAX_WEIGHT_FREEZE_TURRET	5.0f
#define MAX_WEIGHT_MORTAR_TURRET	5.0f
#define MAX_WEIGHT_LASER_TURRET		5.0f
/// AIEntities
#define MAX_WEIGHT_MINI_MINION		3.0f
#define MAX_WEIGHT_RANGED_MINION	4.0f
#define MAX_WEIGHT_TANK_MINION		4.0f
#define MAX_WEIGHT_BOSS_MINION		10.0f
...
#define INFLUENCE_RANGED_MINION		2.0f
